...
import { VegaLiteComponent } from "../src/VegaLiteComponent";

const api = new ComponentApi();

ReactDOM.render(<VegaLiteComponent controller={api.getComponentController()} />, document.getElementById("app")!);
